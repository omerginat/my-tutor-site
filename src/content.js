...
export const FAQS = [
  ...
  { q:"What are your rates?", a:"GCSE and A-Level sessions are {STD} per hour. University admissions sessions (MAT, TMUA, STEP, Oxbridge interviews) are {OXB} per hour. For GCSE and A-Level, the first session is always free. I invoice monthly, and payment is by bank transfer. I ask for 24 hours' notice if you need to cancel or rearrange." },
